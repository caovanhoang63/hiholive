...
import (
	...
	"github.com/caovanhoang63/hiholive/shared/golang/srvctx/components/gormc/dialets"
...
func (gdb *gormDB) Activate(_ srvctx.ServiceContext) error {
	gdb.logger = srvctx.GlobalLogger().GetLogger(gdb.id)
